...
1.  [What is Wright?](#1a)
2.  [Why did we make it?](#1b)
3.  [How does it work?](#1c)
4.  [What are the requirements?](#1d)

[Getting Started](#2)

1.  [Template structure](#2a)
2.  [Comparison with regular templates](#2b)
3.  [Learning Joomla](#2c)
4.  [Learning HTML](#2d)
5.  [Learning CSS](#2e)
6.  [Learning Javascript](#2f)
7.  [Learning PHP](#2g)

[Making Customizations](#3)

1.  [Ground rules for customization](#3a)
2.  [Customizing HTML without altering the template](#3b)
3.  [Customizing CSS without altering the template](#3c)
4.  [Wright tags](#3d)
5.  [Adding custom PHP](#3e)

FAQs

1.  [How fast is the framework?](#4a)
2.  [Do I have to use these Wright tags?](#4b)
...
##### 2b. Comparison with regular templates
...
Joomla User Groups
([http://community.joomla.org/user-groups.html](http://community.joomla.org/user-groups.html)).
They are a great way to meet people and get more connected with Joomla
quickly.
...
use PHP4, and that is the reason for the support. However Joomla 1.6 and
beyond will require PHP 5.2 or greater.\

### 3. Making Customizations

##### 3a. Ground rules for customization
...
##### 3b. Customizing HTML without altering the template
...
##### 3c. Customizing CSS without altering the template
...
##### 4a. How fast is the framework?

In our tests, its just about the same as a regular template. It really
depends on how much data is in the page itself, rather than on the
framework. We are working to find ways to make it even faster than the
default Joomla templates.

##### 4b. Do I have to use these Wright tags?

No, you can replace them with Joomla \<jdoc\> tags. Just realize the CSS
might not work correctly when editing them, so be prepared for that.

### 5. Feedback and Suggestions

Thank you for using our templates. We want to make sure we are providing
a good product, so if you have problems, comments, or ideas, please
contact us.