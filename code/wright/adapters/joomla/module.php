...
class WrightAdapterJoomlaModule
{
	public function render($args)
	{
		...
		{
		    case 'none' :
    		    $html .= '<jdoc:include type="modules" name="'.$args['name'].'" style="'.$args['chrome'].'" extradivs="'.$args['extradivs'].'" />';
    		    break;
		    case 'row' :
		        $doc = JFactory::getDocument();
		        $html .= '<div class="'.$args['type'].'">';
		        $html .= '<jdoc:include type="modules" name="'.$args['name'].'" style="'.$args['chrome'].'" grid="'.$doc->countModules($args['name']).'" extradivs="'.$args['extradivs'].'" />';
		        $html .= '</div>';
		        break;
		    case 'row-fluid' :
		        $doc = JFactory::getDocument();
			...
			case 'fixedgrid' :
				$doc = JFactory::getDocument();
				$html .= '<div class="'.$args['wrapper'].'">';
				$html .= '<jdoc:include type="modules" name="'.$args['name'].'" style="'.$args['chrome'].'" grid="'.$args['grid'].'" extradivs="'.$args['extradivs'].'" />';
				$html .= '</div>';
				break;
			default :
				$html .= '<div class="'.$args['wrapper'].'">';
