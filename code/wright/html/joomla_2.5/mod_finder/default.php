...
{
	$button = '<button class="btn button' . $suffix . ' finder' . $suffix . '" type="submit">' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '</button>';  // Wright v.3: Add btn class
...
<form id="mod-finder-searchform" action="<?php echo JRoute::_($route); ?>" method="get" class="form-search">  <?php // Wright v.3: Added form-search class ?>
