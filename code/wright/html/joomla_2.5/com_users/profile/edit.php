...
<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">  <?php // Wright v.3: Added forn-horizontal class ?>
...
<?php endforeach;?>
		...
		<div class="form-actions">  <?php // Wright v.3: Added form-actions class ?>
			<button type="submit" class="validate btn button btn-primary"><span><?php echo JText::_('JSUBMIT'); ?></span></button>  <?php // Wright v.3: Added btn button btn-primary classes ?>
