...
<div class="reset-confirm<?php echo $this->pageclass_sfx?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=reset.confirm'); ?>" method="post" class="form-validate form-horizontal">  <?php // Wright v.3: Added form-horizontal class ?>
