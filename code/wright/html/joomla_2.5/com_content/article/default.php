...
<div class="item-page<?php echo $this->pageclass_sfx?> row-fluid">
	...
	<p class="article-info">
		...
		<?php if ($params->get('show_publish_date')) : ?>
			<span class="published"><i class="icon-time"></i> <?php echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE_ON', JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC1'))); ?> </span>
		<?php endif; ?>
		<?php if ($params->get('show_modify_date')) : ?>
			<span class="modified"><i class="icon-time"></i> <?php echo JText::sprintf('COM_CONTENT_LAST_UPDATED', JHtml::_('date', $this->item->modified, JText::_('DATE_FORMAT_LC1'))); ?> </span>
		<?php endif; ?>
		<!-- /Dates -->
		<!-- Categories -->
