...
<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">  <?php // Wright v.3: Added form-vertical class ?>
	<fieldset>
		...
		<?php endif; ?>
			...
			<div class="formelm-buttons form-actions">  <?php // Wright v.3: Added form-actions ?>
			<button type="button" class="btn button btn-primary" onclick="Joomla.submitbutton('article.save')">  <?php // Wright v.3: Added btn button btn-primary classes ?>
				<?php echo JText::_('JSAVE') ?>
			</button>
			<button type="button" class="btn button" onclick="Joomla.submitbutton('article.cancel')">  <?php // Wright v.3: Added btn button classes ?>
