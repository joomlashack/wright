			...
			<p>
				...
				<?php elseif ($this->params->get('icons') == 1) : ?>
					<?php if (!$this->params->get('link_icons')) : ?>
						<i class="icon-globe"></i> <?php // Wright v.3: Changed image for icon echo JHtml::_('image', 'system/'.$this->params->get('link_icons', 'weblink.png'), JText::_('COM_WEBLINKS_LINK'), NULL, true); ?>
					<?php else: ?>
				...
				<?php // Code to add the edit link for the weblink. ?>
						...
						<?php if ($canEdit) : ?>
							<ul class="actions unstyled">  <?php // Wright v.3: Added unstyled class ?>
								<li class="edit-icon">
