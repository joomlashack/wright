...
<ul class="category-module unstyled">
	<?php if ($grouped) : ?>
		...
		<ul class="unstyled">
			...
			<li>
				<h<?php echo $item_heading+1; ?>>
					...
					<a class="mod-articles-category-title <?php echo $item->active; ?>" href="<?php echo $item->link; ?>"> <?php echo $item->title; ?>
				...
				<p class="mod-articles-category-readmore"> <a class="mod-articles-category-title <?php echo $item->active; ?> btn btn-primary btn-small" href="<?php echo $item->link; ?>">
