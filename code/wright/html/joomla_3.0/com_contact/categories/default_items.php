		...
		if ($this->params->get('show_empty_categories_cat') || $item->numitems || count($item->getChildren())) :
			...
			<?php $class = ''; ?>
				<h3 class="item-title"> <?php // Wright v.3: Removed page-header ?>
					...
					<?php if ($this->params->get('show_cat_items_cat') == 1) : // Wright v.3: fixed show_cat_items_cat parameter ?>
						<span class="badge badge-info tip hasTooltip" title="<?php echo JHtml::tooltipText('COM_CONTACT_COUNT'); ?>"> <?php // Wright v.3: fixed COM_CONTACT_COUNT text ?>
