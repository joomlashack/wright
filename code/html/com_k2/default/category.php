	...
	<div class="itemList">
		...
		<div id="itemListLeading" >
			<div class="row-fluid">
				...
				<div class="itemContainer span<?php echo number_format(12/$this->params->get('num_leading_columns'), 0); ?> <?php echo $lastContainer; ?>">
					<?php
		...
		<div id="itemListPrimary" >
			<div class="row-fluid">
				...
				<div class="itemContainer span<?php echo number_format(12/$this->params->get('num_primary_columns'), 0); ?> <?php echo $lastContainer; ?>">
					<?php
						// Load category_item.php by default
						$this->item=$item;
						echo $this->loadTemplate('item');
		...
		<div id="itemListSecondary" >
			<div class="row-fluid">
				...
				<div class="itemContainer span<?php echo number_format(12/$this->params->get('num_secondary_columns'), 0); ?> <?php echo $lastContainer; ?>">
					<?php
						// Load category_item.php by default
						$this->item=$item;
						echo $this->loadTemplate('item');
		...
		<div id="itemListLinks" >
			...
			<div class="row-fluid">
				...
				<div class="itemContainer span<?php echo number_format(12/$this->params->get('num_links_columns'), 0); ?> <?php echo $lastContainer; ?>">
					<?php
