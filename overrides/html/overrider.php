	...
	public function getOverride($extension, $layout = 'default')
	{
		...
		switch ($type)
		{
			case 'mod' :
				...
				elseif (is_file(JPATH_THEMES.DS.$app->getTemplate().DS.'html'.DS.'overrides'.DS.self::getVersion().DS.$extension.DS.$layout.'.php'))
					$file = JPATH_THEMES.DS.$app->getTemplate().DS.'html'.DS.'overrides'.DS.self::getVersion().DS.$extension.DS.$layout.'.php';
				break;
			...
			case 'com' :
				...
				elseif (is_file(JPATH_THEMES.DS.$app->getTemplate().DS.'html'.DS.'overrides'.DS.self::getVersion().DS.$folder.DS.$view.DS.$layout.'.php'))
					$file = JPATH_THEMES.DS.$app->getTemplate().DS.'html'.DS.'overrides'.DS.self::getVersion().DS.$folder.DS.$view.DS.$layout.'.php';
				break;
		}
		return $file;
	}
