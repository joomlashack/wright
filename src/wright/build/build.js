            ...
            if (list2) {
                list2.forEach(function(f2) {
                    if (joomlalessRegEx.test(f2)) {
                        ...
                        if (fs.existsSync('../../less/template.less')) {
                            // Template file (if exists)
                            s += '@import url("../../less/template.less"); ';
                        }
                        if (fs.existsSync('../../less/style-' + st + '.less')) {
                            // Style file (if exists)
