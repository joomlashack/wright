...
$label.addClass('active btn-'+btnClass);});};initRadioButtons();})(jQuery);jQuery(document).ready(function(){function stickyFooter(){if(jQuery('#footer')){var h=jQuery('#footer').height();jQuery('.wrapper-footer').height(h);}}
