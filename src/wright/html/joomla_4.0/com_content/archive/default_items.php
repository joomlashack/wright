			...
			<div class="article-info text-muted">
				...
				<?php if ($params->get('show_parent_category') && !empty($item->parent_slug)) : ?>
					<dd>
						<div class="parent-category-name">
							<i class="fas fa-circle-arrow-up"></i> <?php // Wright v.4: Icon ?>
				...
				<?php if ($params->get('show_category')) : ?>
					<dd>
						<div class="category-name">
							<i class="fas fa-folder-open"></i> <?php // Wright v.4: Icon ?>
				...
				<?php if ($info == 0) : ?>
					<?php if ($params->get('show_modify_date')) : ?>
						<dd>
							<div class="modified">
								<span class="fas fa-edit"></span> <?php // Wright v.4: Changed icon ?>
					...
					<?php if ($params->get('show_create_date')) : ?>
						<dd>
							<div class="create">
								<span class="fas fa-pencil"></span> <?php // Wright v.4: Changed icon ?>
			...
			<div class="article-info text-muted">
				...
				<?php if ($info == 1) : ?>
					...
					<?php if ($params->get('show_publish_date')) : ?>
						<dd>
							<div class="published">
								<span class="fas fa-calendar"></span> <?php echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE_ON', JHtml::_('date', $item->publish_up, JText::_('DATE_FORMAT_LC3'))); ?>
							</div>
						</dd>
					<?php endif; ?>
				<?php endif; ?>
				...
				<?php if ($params->get('show_create_date')) : ?>
					<dd>
						<div class="create"><span class="fas fa-calendar">
				...
				<?php if ($params->get('show_modify_date')) : ?>
					<dd>
						<div class="modified"><span class="fas fa-calendar">
				...
				<?php if ($params->get('show_hits')) : ?>
					<dd>
						<div class="hits">
							<span class="fas fa-eye"></span> <?php echo JText::sprintf('COM_CONTENT_ARTICLE_HITS', $item->hits); ?>
						</div>
					</dd>
				<?php endif; ?>
			</dl>
