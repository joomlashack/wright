...
<html>
	...
	<body class="<?php echo $wrightBodyClass ?>">
		...
		?>
		<!-- toolbar -->
		<w:nav containerClass="<?php echo $wrightContainerClass ?>" rowClass="<?php echo $wrightGridMode ?>" wrapClass="fixed-top" type="toolbar" name="toolbar" />
		<?php
			endif;
		?>
		<div class="<?php echo $wrightContainerClass; ?>">
			<!-- header -->
			<header id="header" class="pb-5 pt-5">
			...
			?>
			<!-- menu -->
	   		<w:nav name="menu" containerClass="mb-3" />
			<?php
				endif;
			?>
			<!-- featured -->
			...
			<div id="main-content" class="<?php echo $wrightGridMode; ?>">
				...
				<section id="main">
					...
					?>
					<!-- below-content -->
					<div id="below-content" class="mt-3">
		...
		<div class="wrapper-footer">
		   <footer id="footer" <?php
			if ($this->params->get('stickyFooter', 1))
		   	...
		   	<div class="<?php echo $wrightContainerClass; ?> footer-content pt-3 pb-3">
			   	<?php
